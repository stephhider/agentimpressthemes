<section class="cover fullscreen image-bg overlay">
    <div class="background-image-holder">
        <img alt="image" class="background-image" src="http://placehold.it/1440x960">
    </div>
    <div class="container v-align-transform">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                <div class="feature bordered text-center">
                    <h3 class="uppercase">We would love to show you your new dream home</h3>
                    <p>
                        We have been helping families small and large find their “forever” home
                        for over twenty years. We love what we do and it shows in our results.		                        </p>
                    <form class="halves form-newsletter" data-success="Thanks for your submission, we will be in touch shortly." data-error="Please fill all fields correctly.">
                        ...
                        <button class="mb16" type="submit">Schedule a Visit</button>
